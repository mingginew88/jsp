	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<form id="frmAddArticle" action="/jspTest/addArticle2Result" method="post" enctype="multipart/form-data">
					<input type="hidden" name="board_no" value="${board_no}">
					<input type="hidden" name="article_pno" value="${article_pno}">
					<input type="hidden" name="article_gno" value="${article_gno}">
					<table width="100%">
				        <tr>
				            <td>제목</td>
